...
const STEPS = [
  {
    ...
    icon: Shield,
    content: [
      "Создайте аккаунт через email или телефон на slot-home.ru/performer/auth",
      "Заполните профиль: имя, специализации, опыт работы",
      "Загрузите документы: паспорт, фото с документом, портфолио",
      "Дождитесь проверки — обычно занимает до 24 часов",
      "После одобрения вы получите статус «Верифицирован» и доступ к заказам",
    ],
  },
  {
    num: 2,
