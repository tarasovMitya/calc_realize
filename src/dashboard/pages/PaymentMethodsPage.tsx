...
export function PaymentMethodsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 pt-8 pb-10">
      ...
      <button className="mt-5 w-full flex items-center justify-center gap-2 py-4 rounded-2xl border-2 border-dashed border-gray-200 text-sm font-medium text-gray-500 hover:border-gray-400 hover:text-gray-700 transition-all">
        <Plus size={16} />
        Добавить карту
      </button>
